...
class GSOM:
    ...
    def __init__(self, params, input_vectors, dimensions):
    ...
    def _grow_for_single_iteration_and_single_input(self, input_vector, learning_rate, neigh_radius):
        ...
        winner.adjust_weights(input_vector, 1, learning_rate)
        ...
        for key, node in gsom_nodemap.items():
            ...
            if key != winner_key:
                adjust(node, winner, input_vector, neigh_radius, learning_rate)
